...
public class OMActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setImageResource(com.android.internal.R.drawable.om_logo);
        ...
        String omVersion = SystemProperties.get("ro.om.version");
        omVersion = omVersion.replaceAll("([0-9\\.]+?)-.*", "$1");
        tv.setText("OWLee-Mod " + omVersion);
        ...
        logo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                try {
                    ...
                    android.util.Log.e("OMActivity", "Couldn't catch a break.");
                }
                finish();
                return true;
            }
